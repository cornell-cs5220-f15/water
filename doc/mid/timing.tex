...
steps using Intel’s VTune Amplifier. See \figref{amplxe-command}.
...
From \figref{initial-profile-result}, we could figure out
\ttt{limited\_derivs}, \ttt{compute\_step}, and \ttt{compute\_fg\_sppeds} take
longest time (See \ttt{profile.sh} code). Among these results,
\ttt{limited\_derivs} function definitely was the worst bottleneck.
