#ifndef CENTRAL2D_BUGGY_H
#define CENTRAL2D_BUGGY_H
...
// A buggy copy of central2d used to validate the validator.
 ...
 *
 * The `Central2DBuggy` solver class takes two template arguments:
...
class Central2DBuggy {
public:
    typedef typename Physics::real real;
    typedef typename Physics::vec  vec;

    Central2DBuggy(real w, real h,     // Domain width / height
...
template <class Physics, class Limiter>
template <typename F>
void Central2DBuggy<Physics, Limiter>::init(F f)
{
...
template <class Physics, class Limiter>
void Central2DBuggy<Physics, Limiter>::apply_periodic()
{
...
template <class Physics, class Limiter>
void Central2DBuggy<Physics, Limiter>::compute_fg_speeds(real& cx_, real& cy_)
{
    using namespace std;
    real cx = 1.0e-15;
    real cy = 1.0e-15;
...
template <class Physics, class Limiter>
void Central2DBuggy<Physics, Limiter>::limited_derivs()
{
...
template <class Physics, class Limiter>
void Central2DBuggy<Physics, Limiter>::compute_step(int io, real dt)
{
...
template <class Physics, class Limiter>
void Central2DBuggy<Physics, Limiter>::run(real tfinal)
{
    bool done = false;
    real t = 0;
    while (!done) {
...
template <class Physics, class Limiter>
void Central2DBuggy<Physics, Limiter>::solution_check()
{
    using namespace std;
