#ifndef CENTRAL2D_BLOCK_PAR_H
#define CENTRAL2D_BLOCK_PAR_H
...
public:
    ...
    Central2DBlockPar(const Central2DBlock&) = delete;
...
template <class Physics, class Limiter>
template <typename F>
void Central2DBlockPar<Physics, Limiter>::init(F f) {
...
template <class Physics, class Limiter>
void Central2DBlockPar<Physics, Limiter>::apply_periodic() {
...
template <class Physics, class Limiter>
void Central2DBlockPar<Physics, Limiter>::compute_max_speed(real& cx, real& cy) {
    using namespace std;
    real _cx = 1.0e-15;
    real _cy = 1.0e-15;
...
template <class Physics, class Limiter>
void Central2DBlockPar<Physics, Limiter>::flux(
...
template <class Physics, class Limiter>
void Central2DBlockPar<Physics, Limiter>::limited_derivsx(real* restrict _dx,
...
template <class Physics, class Limiter>
void Central2DBlockPar<Physics, Limiter>::limited_derivsy(real* restrict _dy,
...
template <class Physics, class Limiter>
void Central2DBlockPar<Physics, Limiter>::limited_derivs() {
    using L = Limiter;
    for (int k = 0; k < num_fields; ++k) {
...
template <class Physics, class Limiter>
void Central2DBlockPar<Physics, Limiter>::predictor_flux(
        real* restrict f0, real* restrict f1, real* restrict f2,
        real* restrict g0, real* restrict g1, real* restrict g2,
...
template <class Physics, class Limiter>
void Central2DBlockPar<Physics, Limiter>::corrector(
        real* restrict v,
        const real* restrict u,
        const real* restrict ux,
        const real* restrict uy,
...
template <class Physics, class Limiter>
void Central2DBlockPar<Physics, Limiter>::compute_step(int io, real dt)
{
...
template <class Physics, class Limiter>
void Central2DBlockPar<Physics, Limiter>::run_block(const int io,
                                                 const real dt,
                                                 const int bx,
                                                 const int by) {
    //
...
template <class Physics, class Limiter>
void Central2DBlockPar<Physics, Limiter>::run(real tfinal)
{
...
template <class Physics, class Limiter>
void Central2DBlockPar<Physics, Limiter>::solution_check()
{
    using namespace std;
