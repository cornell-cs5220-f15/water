...
struct Shallow2D {
  ...
  static void vflux(real* F,real* FU, real* FV , real* G,real* GU, real* GV,
		    const real* h, const real* hu, const real* hv, int ncell)
  {
  ...
  static void wavev_speed(real& cx, real& cy, const real* h, const real* hu,
			  const real* hv, int ncell) {
    using namespace std;
    real cx2,cy2;
